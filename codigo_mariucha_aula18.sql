...
SELECT * FROM A18_Departamento;
SELECT * FROM A18_Cargo;
SELECT * FROM A18_Funcionario;
SELECT * FROM A18_Nivel_Cargo;

-- Desafio 01: Mapeamento de Departamentos
SELECT 
...
JOIN A18_Nivel_Cargo nc ON c.salario BETWEEN nc.sal_min AND nc.sal_max
WHERE d.nome_departamento = 'Financeiro' 
AND nc.nivel = 'Pleno';